...
RUNNABLE_TOOLS = [
    ...
    ("Generer coupon 8 + ticket 15", "predictor.py", ["--coupon", "8"]),  # --coupon2 15 est deja la valeur par defaut
    ("Stats du modele (+ reseau de neurones)", "predictor.py", ["--stats"]),
    ("Entrainer le modele", "predictor.py", ["--train"]),
    ("Entrainer le reseau de neurones", "predictor.py", ["--train-nn", "30"]),
]
